...
/**
 * 作者：Yang on 2016/8/23 17:00
 */
public class MyImageView extends ImageView {
    private static final String TAG = "MyImageView";
    private Matrix rematrix = new Matrix();
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            switch (msg.what) {
                ...
                case SCALING:
                    ...
                    count++;
                    mScaleHandler.sendEmptyMessageDelayed(7, 500);
                    break;
                case 6:
                    if (!isFinish) {
                        mScaleHandler.sendEmptyMessage(SCALE_ADD_INIT);
    ...
    public synchronized void RebeginScale() {
        setImageMatrix(rematrix);
    }
