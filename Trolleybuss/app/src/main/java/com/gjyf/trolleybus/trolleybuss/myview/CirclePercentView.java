...
public class CirclePercentView extends View {
    ...
    public CirclePercentView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStripeWidth = a.getDimension(R.styleable.CirclePercentView_stripeWidth, PxUtils.dpToPx(2, context));
        ...
        mBigColor = a.getColor(R.styleable.CirclePercentView_bigColor, Color.WHITE);
