 ...
 * 离线地图模块
 */
public class OfflineBaiduMap extends AppCompatActivity implements MKOfflineMapListener {
    ...
    private void initView() {
        ...
        top_text.setText("离线地图");
        back.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                OfflineBaiduMap.this.finish();
            }
        });
        ...
        hotCityList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                cidView.setText("" + records1.get(i).cityID);
                cityNameView.setText("" + records1.get(i).cityName);
            }
        });
        ...
        allCityList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                cidView.setText("" + records2.get(i).cityID);
                cityNameView.setText("" + records2.get(i).cityName);
            }
        });
    ...
    public class LocalMapAdapter extends BaseAdapter {
        ...
        public View getView(int index, View view, ViewGroup arg2) {
            ...
            view = View.inflate(OfflineBaiduMap.this,
