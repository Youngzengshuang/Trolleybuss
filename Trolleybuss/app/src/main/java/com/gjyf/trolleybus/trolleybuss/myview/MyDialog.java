...
@SuppressLint("WrongViewCast") public class MyDialog extends Dialog {
	...
	public static class Builder {
		...
		public MyDialog create() {
			...
			((TextView) layout.findViewById(R.id.tv_my_dialog_titile))
					.setText(title);
			if (positiveButtonText != null) {
				Button btnPositive = (Button) layout
						.findViewById(R.id.btn_mydialog_positive);
				...
				layout.findViewById(R.id.btn_mydialog_positive).setVisibility(
						View.GONE);
			}

			if (negativeButtonText != null) {
				Button btnNegative = (Button) layout
						.findViewById(R.id.btn_mydialog_negative);
				...
				layout.findViewById(R.id.btn_mydialog_negative).setVisibility(
						View.GONE);
			}
